...
"""CuTe DSL fine-stage implementation for Video Sparse Attention (VSA)."""
...
# The kernel's SMEM buffer for variable_block_sizes is fixed-size and unchecked.
VSA_KERNEL_MAX_CUBES: int = 4 * 1024


class VSAAttention(VSAAttentionBase):
    """VSA frontend with the legacy CuTe DSL block-sparse fine stage."""
